...
namespace GE
{
	struct BufferElements
	{
		...
		Shader::ShaderDataType Type = Shader::ShaderDataType::None;
		uint32_t Offset = 0;
		uint32_t Size = 0;
		...
		BufferElements(Shader::ShaderDataType type, const std::string& name)
			: Name(name), Type(type), Size(Shader::ShaderDataTypeSize(type)), Offset(0), Normalized(false)
		{
